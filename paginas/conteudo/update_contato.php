...
if (in_array($extensao, $formatP)){
  ...
  echo"Formato inválido"; //Seo o formato do arquivo não é permitido, exibe mensagem de erro
}
}else{
...
header("Refresh: 5, home.php");
  ...
  echo "<strong>ERRO DE PDO= </strong>" . $e->getMessage();
            ...
            if ($show->foto_contatos == 'avatar-padrao.png') {
              ...
              echo '<img src="../img/user/' . $show->foto_contatos . '" alt="' . $show->foto_contatos . '" title="' . $show->foto_contatos . '" style="width: 250px; border-radius: 100%; padding-top:15px">';
          }?>
                <h1><?php echo $nome; ?></h1>
